...
**Fuente:** Censo de periodistas asesinados de enero de 1992 a mayo de 2017 del 
...
- El análisis únicamente considera los casos que tienen **motivo confirmado** de asesinato relacionado al trabajo del periodista. En el panel de **Tendencias** se puede observar el número de casos en el tiempo por motivo para diferentes países. 

- Los datos del año 2017 de motivo no confirmado no están disponibles, por lo tanto, imputó el valor con un promedio móvil simple usando el paquete [**imputeTS**](https://cran.r-project.org/web/packages/imputeTS/index.html).  
